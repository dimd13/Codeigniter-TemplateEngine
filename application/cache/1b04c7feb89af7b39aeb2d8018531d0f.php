...
<div id="container">
	...
	<div id="body">
                ...
                <b>Output:</b><br />
                <code>
                <?php echo htmlspecialchars($this->sample_var, ENT_QUOTES); ?>
                </code>
                ...
                <b>Output:</b><br />
                <code>
                <?php if ($this->true_var) { ?>You can see this text, because ture_var set in TRUE!<?php } ?><br />
                <?php if (!$this->true_var) { ?>And you can't see this text, because ture_var not equal to FALSE<?php } ?>
                </code>
                <h2>Arrays</h2>
                <p></p>
                <strong>Controller:</strong>
                ...
                <b>Output:</b><br />
                <code>
                <?php if (is_array($this->list)) foreach ($this->list as &$list) { ?>
                    <p>NAME: <?php if (isset($list['name'])) echo htmlspecialchars($list['name'], ENT_QUOTES); ?>, AGE: <?php if (isset($list['age'])) echo htmlspecialchars($list['age'], ENT_QUOTES); ?></p>
                <?php } ?>
                </code>
	</div>
